...
def find_arbitrage(matched: list[MatchedEvent],
    ...
    for match in matched:
        ...
        yes_allocation_pct = best_yes_market.yes_price / (best_yes_market.yes_price + best_no_market.no_price)
        no_allocation_pct = best_no_market.no_price / (best_yes_market.yes_price + best_no_market.no_price)
